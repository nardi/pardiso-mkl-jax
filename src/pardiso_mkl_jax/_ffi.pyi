...
# Process-wide count of factorization rebuilds (handle was evicted or freed),
# and a reset. Wrapped by primitive.rebuild_count / reset_rebuild_count.
def rebuild_count() -> int: ...
def reset_rebuild_count() -> None: ...

# Process-wide count of analyze()/factor() calls that reused an existing slot
# instead of redoing the work, and a reset. Wrapped by
# primitive.dedup_hit_count / reset_dedup_hit_count.
